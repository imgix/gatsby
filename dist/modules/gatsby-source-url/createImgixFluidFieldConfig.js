...
var createImgixFluidFieldConfig = function (_a) {
    ...
    return ({
        type: type !== null && type !== void 0 ? type : graphqlTypes_1.createImgixFluidType({
            cache: cache,
        }),
...
var createImgixFluidSchemaFieldConfig = function (args) {
    return exports.createImgixFluidFieldConfig(args);
};
exports.createImgixFluidSchemaFieldConfig = createImgixFluidSchemaFieldConfig;
